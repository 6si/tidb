...
func (s *PartitionProcessor) processShardedListPartition(ds *logicalop.DataSource, origPI, flatPI *model.PartitionInfo, opt *optimizetrace.LogicalOptimizeOp) (base.LogicalPlan, error) {
